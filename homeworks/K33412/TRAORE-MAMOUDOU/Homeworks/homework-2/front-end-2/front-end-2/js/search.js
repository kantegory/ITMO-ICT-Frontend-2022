                        ...
                        html += `
                            <div class="d-flex events" id = ${e.id}>
                                ...
                                <div style="width:100%" class="d-flex flex-column justify-content-evenly ms-2">
                                        <span style="color:gray;" class="fw-bold"> ${e['datetime_utc'].split('T')[0]} @ ${e['datetime_utc'].split('T')[1]}</span>
                                        <span style="color: black;" class="fw-bold">${e['venue']['name']} </span>
                                        <span style="color:rgb(104, 91, 91);" class="fw-light"> ${eType} . ${e['venue']['city']}, ${e['venue']['country']}</span>
                                        <div class='d-flex justify-content-between search-result-description'>
                                            <span style="color:rgb(104, 91, 91);" class="fw-light">${e['venue']['id']} attendees</span>
                ...
                data.hits.forEach(e => {
                    html += `
                        ...
                        <div class="d-flex groups id=${e.id}">
                            ...
                            <div style="width:100%" class="d-flex flex-column justify-content-evenly ms-2">
                                <div class="d-flex">
                                    <span style="color: black;" class="fw-bold me-2">${e.user}</span>
                                    <div class="group-members">
                                        <i style="color:gray;" class="fa fa-user"> ${e.collections}</i>
                                        <span style="color:gray;"></span>
                                    </div>
                                </div>
                                <i class="fa fa-thumbs-up">: ${e.likes}</i>
                                <i class="fa fa-eye">: ${e.views}</i>
                                <div class='d-flex justify-content-between search-result-description'>
