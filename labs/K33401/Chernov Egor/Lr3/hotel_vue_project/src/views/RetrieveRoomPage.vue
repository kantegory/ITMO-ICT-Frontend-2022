    ...
    <div id="retrieveRoomPage">
      <div class="container col-8 justify-content-center py-4">
        ...
        <div v-for="comment in comments" :key="comment.id">
          <comment-room v-if="comment.room_com.id.toString() === room.id.toString()" :username="comment.user_com.username" :rating_com="comment.rating_com" :review_com="comment.review_com" :check_in_com="comment.check_in_com" :check_out_com="comment.check_out_com"/>
        </div>
