<template>
  <div
    ...
    <div style="height:540px; padding:0; margin:0; width: 100%;" id="coin">
      <iframe
          :src="`https://widget.coinlib.io/widget?type=chart&theme=light&coin_id=${coinlib_id}&pref_coin_id=1505`"
          width="100%" height="536px" border="0" style="border:0; margin:0; padding:0; line-height:14px;"></iframe>
    </div>
    <div
