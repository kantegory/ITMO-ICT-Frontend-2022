...
function logout() {
    ...
    window.location.href = "http://localhost:9999/f/labs/K33401/Kormanovskaya/website/pages/index.html"
}
...
function searchTitle() {
    ...
    params.append('q', document.getElementById('textSearch').value)
    window.location.replace(`http://localhost:9999/f/labs/K33401/Kormanovskaya/website/pages/search.html?${params.toString()}`)
}
