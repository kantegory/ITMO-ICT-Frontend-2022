	...
	<footer class="container-fluid pt-5 colors">
		<div class="row justify-content-between p-2">
			...
			<div class="col-2 text-color">
				<h3>Найти</h3>
				<ul class="nav flex-column">
					<li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-color">Список криптовалют</a></li>
					<li class="nav-item mb-2"><a href="/Graphics" class="nav-link p-0 text-color">Графики</a></li>
				</ul>
			</div>
