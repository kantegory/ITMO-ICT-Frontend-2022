	...
	<main class="container-xl p-5">
		<form class="d-flex-column" @submit.prevent="register">
			...
			<div class="row mb-3 justify-content-center">
				...
				<div class="col-sm-3">
					<input type="text" class="form-control" v-model="form.firstname" name="firstname" id="inputName3" placeholder="" required>
				</div>
			</div>
			<div class="row mb-3 justify-content-center">
				<label for="inputSurname3" class="col-sm-1 col-form-label">Фамилия</label>
				<div class="col-sm-3">
					<input type="text" class="form-control" v-model="form.lastname" name="lastname" id="inputSurname3" placeholder="Селезнев" required>
				</div>
			</div>
			<div class="row mb-3 justify-content-center">
			...
			<div class="row mb-3 justify-content-center">
				...
				<div class="col-sm-3">
					<input type="text" class="form-control" v-model="form.login" name="login" id="inputLogin3" placeholder="SeLeZniOFF" required>
				</div>
			</div>
			<div class="row mb-3 justify-content-center">
