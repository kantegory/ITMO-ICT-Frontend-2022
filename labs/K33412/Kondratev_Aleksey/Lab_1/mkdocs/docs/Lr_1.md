...
В данной лабораторной работе мы смогли познакомится с Boostrap и на практике изучить его принцип работы, а также потренировать наши навыке в HTML и CSS.
