	...
	<main class=" row mx-auto d-flex pt-5 color-main">
		<section class="container row mx-auto">
			<div class="row d-flex justify-content-start col-md-5 col-lg-5 col-xl-3 col-12 col-sm-12 mx-5 mt-5">
				<img src="../assets/image/Ава.jpg" alt="..." style="padding: 0">
			</div>
			<div class="row d-flex justify-content-start col-xl-6 col-lg-7 col-md-7 col-9 col-sm-12 mt-5">
				<ul>
					<h1 class="text mt-1 custom-colored-h2 mt-5 mb-5 mx-5">Пользователь: Еремеева Арина</h1>
					<h2 class="text mt-2 h4 custom-colored-h2 mx-5">Зарегистрирован: 10 декабря 2022</h2>
					<h3 class="text mt-2 h4 custom-colored-h2 mx-5">Интересы: фотография, рисунок, живопись, видео, искусство</h3>
					<h3 class="text mt-4 h4 custom-colored-h2 mx-5">Страница VK: <a href="https://vk.com/arrrishaaaaaaaaa">https://vk.com/arrrishaaaaaaaaa</a></h3>
