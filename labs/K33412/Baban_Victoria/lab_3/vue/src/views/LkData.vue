<template>
  <Header/>
  <main class="p-5 container-fluid d-flex flex-row vh-100 color-main">
    <aside  class="col-lg-3   d-flex flex-column justify-content-start">
      ...
      <ul class="list-group col-12">
        ...
        <li class="list-group-item form-color">
          <a class="text-decoration-none text "  href="#" @click="$router.push('/lk/')">Мои мероприятия</a>
        </li>
        <li class="list-group-item form-color">
    ...
    <section class="col-lg-6   px-5">
      <h2 class="text">Мои данные</h2>
      <div class="row mt-4 ">
          <ul class="list-group ">
            <li class="list-group-item form-color">Имя: {{ user.first_name }}</li>
            <li class="list-group-item form-color">Фамилия: {{ user.last_name }}</li>
            <li class="list-group-item form-color">ID: {{ user.id }}</li>
            <li class="list-group-item form-color">Email: {{ user.email }}</li>
            <li class="list-group-item form-color">Username: {{ user.username }}</li>
          </ul>
      </div>
    </section>
  </main>
