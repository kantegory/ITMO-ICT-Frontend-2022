<template>
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 border-top navbar-expand-lg navbar-dark navbar" style="background-color: #20c997;">
